...
var EBCheckbox = (function (_super) {
    ...
    EBCheckbox.prototype.render = function () {
        var stylesLiArr = this.state.isDisabled ? [css.LiBase, css.LiDisabled] : [css.LiBase, css.LiActive];
        var cssInputArr = this.state.isDisabled ? [css.Input, css.InputDisabled] : [css.Input, css.InputActive];
