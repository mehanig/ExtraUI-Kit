...
var ColumnIconActive = (function (_super) {
    ...
    ColumnIconActive.prototype.render = function () {
        return (React.createElement("img", { className: this.props.className, src: "data:image/png;" + base64Active }));
    };
...
var ColumnIconInactive = (function (_super) {
    ...
    ColumnIconInactive.prototype.render = function () {
        return (React.createElement("img", { className: this.props.className, src: "data:image/png;" + base64Inactive }));
    };
