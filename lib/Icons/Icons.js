...
var TriangleArrow_1 = require("./TriangleArrow");
...
var Icons = (function (_super) {
    ...
    function Icons() {
        ...
        _this.ICON_MAPPING = {
            ...
            TriangleArrowRight: TriangleArrow_1.TriangleArrowRight,
            TriangleArrowRightHover: TriangleArrow_1.TriangleArrowRightHover,
            TriangleArrowDown: TriangleArrow_1.TriangleArrowDown,
            SearchIcon: SearchIcon_1.SearchIcon,
            LightBulbIcon: LightBulbIcon_1.LightBulbIcon,
            LightBulbIconActive: LightBulbIcon_1.LightBulbIconActive,
        };
        return _this;
    }
    Icons.prototype.render = function () {
        var Component = this.ICON_MAPPING[this.props.type];
        return React.createElement(Component, { className: this.props.className });
    };
    return Icons;
}(React.Component));
