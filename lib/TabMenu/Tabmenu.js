...
var TabMenu = (function (_super) {
    ...
    TabMenu.prototype.render = function () {
        ...
        var tabs = this.state.values.map(function (itemValue, index) {
            ...
            return (React.createElement("span", { key: index, "data-value": itemValue, style: styleTab, onClick: _this.onTabClick }, tabContent));
        });
    ...
    TabMenu.prototype.onTabClick = function (clickEvent) {
        var safeTypeValue = clickEvent.currentTarget.getAttribute("data-value");
