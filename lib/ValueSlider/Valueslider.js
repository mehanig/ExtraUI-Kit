...
var ValueSlider = (function (_super) {
    ...
    ValueSlider.prototype.render = function () {
        ...
        var IconComponent = this.props.icon ? React.createElement(Icons_1.default, { type: this.props.icon }) : null;
        if (this.props.iconClick) {
            IconComponent = (React.createElement("span", { style: { cursor: "pointer" }, onClick: this.handleIconClick }, IconComponent));
        }
        var IconComponentNoClick = this.props.icon && !this.props.iconClick ? React.createElement(Icons_1.default, { type: this.props.icon }) : null;
