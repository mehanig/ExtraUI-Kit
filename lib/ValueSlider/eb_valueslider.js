            ...
            React.createElement(radium_1.StyleRoot, null,
                React.createElement("div", { style: mainBase },
                    ...
                    !this.state.isEditBoxMounted ?
                        (React.createElement("span", { style: [css.Draggable], onMouseDown: function (e) { _this.onMouseDown(e); }, onMouseMove: function (e) { _this.onMouseMove(e); }, onDoubleClick: function (e) { _this.mountEditValueBox(); }, onMouseUp: function (e) { _this.onMouseUp(e); } }, this.state.currentValue)) : (React.createElement("span", { style: [css.Draggable], onClick: function (e) { _this.unmountEditValueBoxSave(); } },
